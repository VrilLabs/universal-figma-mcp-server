...
A Cloudflare Worker-based MCP (Model Context Protocol) server that wraps the Figma REST API, enabling GitHub Copilot Cloud Agent and other MCP clients to access Figma design data.
